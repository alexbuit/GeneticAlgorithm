/****************************************************
 * FileName: ring1_set.c
 * Description:
 *
 * (c) 2009, FlexibleOptical
...
int main (int argc, char *argv[])
{
    ...
    if(TOTAL_NR_OF_CHANNELS==39)         first_channel=24;
      else if(TOTAL_NR_OF_CHANNELS==79)  first_channel=70;
        else if(TOTAL_NR_OF_CHANNELS==19)  first_channel=18;
         else
          {
